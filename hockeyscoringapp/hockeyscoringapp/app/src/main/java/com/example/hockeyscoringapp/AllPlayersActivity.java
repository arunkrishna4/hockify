...
public class AllPlayersActivity extends AppCompatActivity implements PlayerAdapter.OnPlayerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allPlayersAdapter = new PlayerAdapter(getSamplePlayers(), (PlayerAdapter.OnPlayerClickListener) this);
        ...
        mostGoalsAdapter = new PlayerAdapter(getSampleMostGoalsPlayers(), (PlayerAdapter.OnPlayerClickListener) this);
    ...
    public void onPlayerClick(Player player) {
        Intent intent = new Intent(AllPlayersActivity.this, playerstats.class);
