...
public class MainActivity extends AppCompatActivity implements MatchAdapter.OnMatchClickListener, PlayerAdapter.OnPlayerClickListener {
    ...
    public void onMatchClick(Match match) {
        // 1. Create an Intent for the MatchSummaryActivity
        Intent intent = new Intent(MainActivity.this, matchsummary.class);

        // 2. Package all relevant match data to pass to the new activity
        // NOTE: Match class must have getters for these properties
        ...
        Toast.makeText(this, "Loading summary for " + match.getTeamA() + " vs " + match.getTeamB(), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onPlayerClick(Player player) {
        ...
        startActivity(intent);
        Toast.makeText(this, "Loading stats for " + player.getName(), Toast.LENGTH_SHORT).show();
    }
